...
let 
    SystemFunctions* = @[
        ...
        SystemFunction(lib:"base",          name:"let",                 call:Base_let),
        ...
        SystemFunction(lib:"base",          name:"var",                 call:Base_var),
        ...
        SystemFunction(lib:"convert",       name:"toBin!",              call:Convert_toBinI),
        ...
        SystemFunction(lib:"convert",       name:"toHex!",              call:Convert_toHexI),
        SystemFunction(lib:"convert",       name:"toInt",               call:Convert_toInt),
        SystemFunction(lib:"convert",       name:"toInt!",              call:Convert_toIntI),
        ...
        SystemFunction(lib:"convert",       name:"toNumber!",           call:Convert_toNumberI),
        ...
        SystemFunction(lib:"convert",       name:"toOct!",              call:Convert_toOctI),
        SystemFunction(lib:"convert",       name:"toReal",              call:Convert_toReal),#            req:@[@[IV]],                                                                      ret: @[SV],             desc:"convert given integer number to real",
        SystemFunction(lib:"convert",       name:"toReal!",             call:Convert_toRealI),
        ...
        SystemFunction(lib:"convert",       name:"toString!",           call:Convert_toStringI),
        ...
        SystemFunction(lib:"math",          name:"dec",                 call:Math_dec),
        SystemFunction(lib:"math",          name:"dec!",                call:Math_decI),
        ...
        SystemFunction(lib:"math",          name:"fact",                call:Math_fact),
        ...
        SystemFunction(lib:"math",          name:"nextPrime",           call:Math_nextPrime),
