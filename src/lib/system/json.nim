...
proc generateJsonNode*(n: Value): JsonNode =
    case n.kind
        of SV       : result = newJString(n.s)
        of IV       : result = newJInt(n.i)
        of RV       : result = newJFloat(n.r)
        of BV       : result = newJBool(n.b)
