...
proc mz_adler32*(adler: mz_ulong, pointr: ptr uint8, buf_len: csize_t): mz_ulong {.importc.}
const 
  MZ_CRC32_INIT* = (0)

# mz_crc32() returns the initial CRC-32 value to use when called with ptr==NULL.

proc mz_crc32*(crc: mz_ulong; pointr: ptr uint8; buf_len: csize_t): mz_ulong {.importc.}
...
when not(defined(MINIZ_NO_ZLIB_APIS)): 
  ...
  proc mz_compress*(pDest: ptr uint8; pDest_len: ptr mz_ulong; 
                    pSource: ptr uint8; source_len: mz_ulong): cint {.importc.}
  proc mz_compress2*(pDest: ptr uint8; pDest_len: ptr mz_ulong; 
  ...
  proc mz_uncompress*(pDest: ptr uint8; pDest_len: ptr mz_ulong; 
                      pSource: ptr uint8; source_len: mz_ulong): cint {.importc.}
