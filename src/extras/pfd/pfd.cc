...
void pfd_notification(const char* title, const char* message, int ic){
    pfd::notify(
        title, 
        message, 
        (pfd::icon)ic
...
int pfd_message(const char* title, const char* message, int tp, int ic){
    return (int)pfd::message(
        title, 
        message, 
        (pfd::choice)tp, 
        (pfd::icon)ic
