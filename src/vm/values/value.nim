...
let
    ...
    VTRUE*          = makeConst Value(kind: Logical, flags: True)                     ## constant True
    VFALSE*         = makeConst Value(kind: Logical, flags: False)                    ## constant False
    VMAYBE*         = makeConst Value(kind: Logical, flags: Maybe)                    ## constant Maybe
