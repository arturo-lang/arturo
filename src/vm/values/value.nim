...
func newBuiltin*(name: sink string, pr: PrecedenceKind, desc: sink string, ar: int, ag: sink OrderedTable[string,ValueSpec], at: sink OrderedTable[string,(ValueSpec,string)], ret: ValueSpec, exa: sink string, act: BuiltinAction): Value {.inline, enforceNoRaises.} =
    Value(
        kind    : Function, 
