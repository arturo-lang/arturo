...
template I0*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 0)
template I1*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 1)
template I2*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 2)
template I3*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 3)
template I4*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 4)
template I5*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 5)
template I6*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 6)
template I7*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 7)
template I8*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 8)
template I9*():Value            = Value(kind: Integer, iKind: NormalInteger, i: 9)
template I10*():Value           = Value(kind: Integer, iKind: NormalInteger, i: 10)
template I11*():Value           = Value(kind: Integer, iKind: NormalInteger, i: 11)
template I12*():Value           = Value(kind: Integer, iKind: NormalInteger, i: 12)
template I13*():Value           = Value(kind: Integer, iKind: NormalInteger, i: 13)
template I14*():Value           = Value(kind: Integer, iKind: NormalInteger, i: 14)
template I15*():Value           = Value(kind: Integer, iKind: NormalInteger, i: 15)

template I1M*():Value           = Value(kind: Integer, iKind: NormalInteger, i: -1)

template F0*():Value            = Value(kind: Floating, f: 0.0)
template F1*():Value            = Value(kind: Floating, f: 1.0)
template F2*():Value            = Value(kind: Floating, f: 2.0)

template F1M*():Value           = Value(kind: Floating, f: -1.0)

template VTRUE*():Value         = Value(kind: Logical, b: True)
template VFALSE*():Value        = Value(kind: Logical, b: False)
template VMAYBE*():Value        = Value(kind: Logical, b: Maybe)

template VNULL*():Value         = Value(kind: Null)

template VEMPTYSTR*():Value     = Value(kind: String, s: "")
template VEMPTYARR*():Value     = Value(kind: Block, a: @[], data: nil, dirty: false)
template VEMPTYDICT*():Value    = Value(kind: Dictionary, d: initOrderedTable[string,Value]())

template VSTRINGT*():Value      = Value(kind: Type, tpKind: BuiltinType, t: String)
template VINTEGERT*():Value     = Value(kind: Type, tpKind: BuiltinType, t: Integer)

template VNOTHING*():Value      = Value(kind: Nothing)
