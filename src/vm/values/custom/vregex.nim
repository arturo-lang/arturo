...
when defined(windows): 
    ...
    when defined(arm64):
        {.passL: "-Bstatic -Lsrc/deps/pcre/macos/arm64 -lpcre -Bdynamic".}
    else:
        {.passL: "-Bstatic -Lsrc/deps/pcre/macos/amd64 -lpcre -Bdynamic".}
elif defined(linux):
    when defined(arm64):
    ...
    {.passL: "-Bstatic -src/deps/pcre/deps/freebsd/amd64 -lpcre -Bdynamic".}
