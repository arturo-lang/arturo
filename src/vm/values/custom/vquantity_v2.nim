...
type
    ...
    UnitType* = enum
        ...
        # Area
        M2, DM2, CM2, MM2, MIM2, NM2, KM2, IN2, FT2, YD2, ANG2, MI2, AC, ARE, HA
...
const
    Units*: Table[UnitType,UnitSpec] = {
        ...
        YD:     ("yard"         ,   "",     0.9144),
        ANG:    ("angstrom"     ,   "",     1e-10),
        LY:     ("lightyear"    ,   "",     9.461e+15),
        PC:     ("parsec"       ,   "",     3.086e+16),
        AU:     ("astronomicalunit", "",    1.496e+11),
        CHAIN:  ("chain"        ,   "",     20.1168),
        ROD:    ("rod"          ,   "",     5.0292),
        FUR:    ("furlong"      ,   "",     201.168),
        MI:     ("mile"         ,   "",     1609.344),
...
#         (["ly", "lightyear"], U_ly),
#         (["pc", "parsec"], U_pc),
#         (["au", "astronomicalunit"], U_au),
#         (["chain", ""], U_chain),
#         (["rod", "rd"], U_rod),
#         (["fur", "furlong"], U_fur),
#         (["mi", "mile"], U_mi),
#         (["nmi", "nauticalmile"], U_nmi)
#     ]
...
#     ErrorQuantity* = Unit(kind: NoUnit, name: NoName)
#     NumericQuantity* = Unit(kind: NoUnit, name: B)
...
#     Unit(kind: quantityKindForName(un), name: un)
...
#     return Unit(kind: b.kind, name: parseEnum[UnitName](s))
